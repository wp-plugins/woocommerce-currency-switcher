...
final class WOOCS
{
    ...
    public $the_plugin_version = '1.1.0';
    ...
    public function __construct()
    {
        ...
        add_filter('woocommerce_currency_symbol', array($this, 'woocommerce_currency_symbol'), 9999, 2);
        ...
        //add_filter('woocommerce_order_amount_total_shipping', array($this, 'woocommerce_update_shipping_method'), 9999);
        ...
        //commented from 2.0.9
        //add_filter('woocommerce_order_amount_total', array($this, 'woocommerce_order_amount_total'), 9999);
        //+++ AJAX ACTIONS
    ...
    public function raw_woocommerce_price($price)
    {
        ...
        {
            $price = number_format(floatval(round($price, 0, PHP_ROUND_HALF_EVEN)), 0, '.', '');
        }
