...
<div class="subsubsub_section">
    ...
    $options = array(
        ...
        array(
            ...
            'css' => 'min-width:300px;',
            'options' => array(
                0 => __('No - premium only', 'woocommerce-currency-switcher'),
            ),
            'desc_tip' => true
        ),
        array(
    ...
    <div class="section">
        ...
        <div id="tabs">
            <ul>
                <li><a href="#tabs-1"><?php _e("Currencies", 'meta-data-filter') ?></a></li>
                <li><a href="#tabs-2"><?php _e("Options", 'meta-data-filter') ?></a></li>
                <?php if ($this->is_use_geo_rules()): ?>
                    <li><a href="#tabs-3"><?php _e("GeoIP options", 'meta-data-filter') ?></a></li>
                <?php endif; ?>
            </ul>
            ...
            <div id="tabs-2">
                ...
                <b>*</b> - means in premium version only!<br />
            </div>
    ...
    <table style="width: 100%;">
        <tr>
            ...
            <td style="width: 50%;">
                ...
                <a href="https://wordpress.org/plugins/woocommerce-products-filter/" target="_blank"><img src="<?php echo WOOCS_LINK ?>img/woof_banner.png" alt="<?php _e("WOOF", 'woocommerce-currency-switcher'); ?>" /></a>
            </td>
        </tr>
    </table>
