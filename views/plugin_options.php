...
<div class="subsubsub_section">
    ...
    $options = array(
        ...
        array(
            ...
            'desc' => __('Use GeoLocation rules for your currencies. This feature uses native WC_Geolocation php class! Works from woocommerce >= 2.3.0. In the premium version only!', 'woocommerce-currency-switcher'),
        ...
        array(
            ...
            'desc' => __('Currencies rate auto update by wp cron. In the premium version only!', 'woocommerce-currency-switcher'),
...
function woocs_print_currency($_this, $currency)
{
    ...
    <li style="width: 95%;">
        ...
        <input type="text" value="<?php echo $currency['description'] ?>" name="woocs_description[]" class="woocs-text" style="width: 250px;" placeholder="<?php _e("description", 'woocommerce-currency-switcher') ?>" />
        <?php
